...
function visibilityTone(isPublic: boolean): "warning" | "danger" {
  return isPublic ? "warning" : "danger";
}
      ...
      <section className="content-grid">
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        <span className={`status-pill ${visibilityTone(prayer.isPublic)}`}>
                          {prayer.isPublic ? "Public" : "Private"}
                        </span>
                        <span className={`status-pill ${statusTone(prayer.status)}`}>
        ...
        <section className="editor-card">
          <div className="section-title-row">
            <h2>Prayer Detail</h2>
            {selectedPrayer ? (
              <span className={`status-pill ${statusTone(selectedPrayer.status)}`}>
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <span className={`status-pill ${visibilityTone(selectedPrayer.isPublic)}`}>
