  ...
  return (
    <main>
      ...
      <BatchUploadDialog
        ...
        onCompleted={load}
        title="Devotions"
        subtitle="Queue up a month of devotions, each scheduled to publish on its own date."
        storageKey="batch-mode:devotions"
        fileRequired={false}
        fileLabel="Cover image (optional)"
        accept="image/png,image/jpeg,image/webp"
        mediaKind="image"
        fields={[
          { key: "title", label: "Title", type: "text", required: true },
          { key: "scripture", label: "Scripture reference", type: "text", placeholder: "e.g. John 3:16" },
          { key: "excerpt", label: "Excerpt", type: "textarea", rows: 2, fullWidth: true, required: true },
          { key: "body", label: "Devotion body", type: "textarea", rows: 6, fullWidth: true, required: true }
        ]}
        submitOne={async ctx => {
          const v = ctx.values;
