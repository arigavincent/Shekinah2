  ...
  return (
    <main>
      ...
      <BatchUploadDialog
        ...
        subtitle="Upload multiple PDFs, audio, or video resources with per-item publish dates."
        storageKey="batch-mode:library"
        acceptFor={values =>
        ...
        mediaKind={values =>
          values.fileType === "audio" ? "audio" : values.fileType === "video" ? "video" : "document"
        }
        ...
        fields={[
          ...
          { key: "category", label: "Category", type: "text", required: true, default: "Study Guides" },
          { key: "title", label: "Title", type: "text", required: true, fullWidth: true },
          { key: "author", label: "Author / Source", type: "text", required: true, default: "Shekinah Sons Global" },
          { key: "coverUrl", label: "Cover URL (optional)", type: "text", placeholder: "https://..." },
          { key: "description", label: "Description", type: "textarea", rows: 3, fullWidth: true, required: true }
        ]}
        submitOne={async ctx => {
          const v = ctx.values;
          await createLibraryItem({
            ...
            author: v.author.trim() || "Shekinah Sons Global",
            category: v.category.trim() || "Study Guides",
            coverUrl: v.coverUrl.trim(),
            fileUrl: ctx.mediaUrl,
            fileType: v.fileType || "pdf",
            fileSizeBytes: ctx.mediaSizeBytes,
            isFeatured: false,
